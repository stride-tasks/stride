...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 653517982;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        70 => wire__stride_core__task__task_default_impl(port, ptr, rust_vec_len, data_len),
        71 => wire__stride_core__task__task_entry_impl(port, ptr, rust_vec_len, data_len),
