...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 684389212;
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse::<_, ()>((move || {
                ...
                let output_ok =
                    Result::<_, ()>::Ok(crate::api::repository::oid_to_string(&*api_oid_guard))?;
                Ok(output_ok)
            })())
        },
    )
...
impl SseDecode for crate::api::repository::CommitItem {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        return crate::api::repository::CommitItem {
            oid: var_oid,
            parent: var_parent,
            message: var_message,
            author: var_author,
...
impl SseDecode for Vec<crate::api::repository::CommitItem> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut len_ = <i32>::sse_decode(deserializer);
        let mut ans_ = vec![];
...
impl SseDecode for Option<Vec<crate::api::repository::CommitItem>> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        if (<bool>::sse_decode(deserializer)) {
            return Some(<Vec<crate::api::repository::CommitItem>>::sse_decode(
                deserializer,
            ));
        } else {
            return None;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        9 => wire__crate__api__repository__TaskStorage_add_impl(port, ptr, rust_vec_len, data_len),
        10 => wire__crate__api__repository__TaskStorage_add_and_commit_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        11 => wire__crate__api__repository__TaskStorage_change_category_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        12 => wire__crate__api__repository__TaskStorage_checkout_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        14 => wire__crate__api__repository__TaskStorage_clone_repository_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        15 => wire__crate__api__repository__TaskStorage_force_hard_reset_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        17 => wire__crate__api__repository__TaskStorage_log_impl(port, ptr, rust_vec_len, data_len),
        19 => {
            wire__crate__api__repository__TaskStorage_push_impl(port, ptr, rust_vec_len, data_len)
        }
        20 => wire__crate__api__repository__TaskStorage_remove_task_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        22 => wire__crate__api__repository__TaskStorage_task_by_uuid_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        24 => wire__crate__api__repository__TaskStorage_tasks_with_filter_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        27 => wire__crate__api__repository__init_app_impl(port, ptr, rust_vec_len, data_len),
        ...
        31 => wire__crate__api__settings__settings_default_impl(port, ptr, rust_vec_len, data_len),
        32 => wire__crate__api__settings__settings_load_impl(port, ptr, rust_vec_len, data_len),
        34 => wire__crate__api__settings__settings_save_impl(port, ptr, rust_vec_len, data_len),
        35 => wire__crate__api__settings__ssh_key_generate_impl(port, ptr, rust_vec_len, data_len),
        38 => wire__crate__task__task_with_uuid_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        18 => wire__crate__api__repository__TaskStorage_new_impl(ptr, rust_vec_len, data_len),
        28 => wire__crate__api__repository__oid_to_string_impl(ptr, rust_vec_len, data_len),
        33 => wire__crate__api__settings__settings_new_impl(ptr, rust_vec_len, data_len),
        36 => wire__crate__task__task_new_impl(ptr, rust_vec_len, data_len),
        37 => wire__crate__task__task_urgency_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::api::repository::CommitItem {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::repository::CommitItem
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::repository::CommitItem>
    for crate::api::repository::CommitItem
{
    fn into_into_dart(self) -> crate::api::repository::CommitItem {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
...
impl SseEncode for crate::api::repository::CommitItem {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
...
impl SseEncode for Vec<crate::api::repository::CommitItem> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <i32>::sse_encode(self.len() as _, serializer);
        for item in self {
...
impl SseEncode for Option<Vec<crate::api::repository::CommitItem>> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <bool>::sse_encode(self.is_some(), serializer);
        if let Some(value) = self {
            <Vec<crate::api::repository::CommitItem>>::sse_encode(value, serializer);
        }
    }
}
