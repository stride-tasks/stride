...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1617300338;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        12 => wire__crate__api__repository__Repository_insert_task_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        14 => wire__crate__api__repository__Repository_purge_task_by_id_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        15 => wire__crate__api__repository__Repository_sync_impl(port, ptr, rust_vec_len, data_len),
        16 => wire__crate__api__repository__Repository_task_by_id_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        17 => wire__crate__api__repository__Repository_task_query_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        18 => wire__crate__api__repository__Repository_tasks_by_status_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        19 => wire__crate__api__repository__Repository_undo_impl(port, ptr, rust_vec_len, data_len),
        20 => wire__crate__api__repository__Repository_update_backend_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        21 => wire__crate__api__repository__Repository_update_task_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        27 => wire__crate__api__settings__SshKey_generate_impl(port, ptr, rust_vec_len, data_len),
        29 => wire__crate__api__settings__SshKey_remove_key_impl(port, ptr, rust_vec_len, data_len),
        30 => wire__crate__api__settings__SshKey_save_impl(port, ptr, rust_vec_len, data_len),
        31 => wire__crate__api__settings__SshKey_update_impl(port, ptr, rust_vec_len, data_len),
        33 => wire__stride_core__task__annotation__annotation_now_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        34 => wire__crate__api__settings__application_paths_default_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        36 => wire__crate__api__logging__debug_impl(port, ptr, rust_vec_len, data_len),
        37 => wire__crate__api__plugin_manager__disable_impl(port, ptr, rust_vec_len, data_len),
        38 => wire__crate__api__plugin_manager__emit_impl(port, ptr, rust_vec_len, data_len),
        39 => {
            wire__crate__api__plugin_manager__emit_broadcast_impl(port, ptr, rust_vec_len, data_len)
        }
        40 => wire__stride_backend_git__encryption_key__encryption_key_generate_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        84 => wire__stride_core__task__task_with_uuid_impl(port, ptr, rust_vec_len, data_len),
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        13 => wire__crate__api__repository__Repository_open_impl(ptr, rust_vec_len, data_len),
        22 => wire__crate__api__error__RustError_as_unknown_host_impl(ptr, rust_vec_len, data_len),
        23 => wire__crate__api__error__RustError_is_key_store_verification_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        24 => wire__crate__api__error__RustError_is_out_of_fuel_trap_code_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        25 => wire__crate__api__error__RustError_plugin_name_impl(ptr, rust_vec_len, data_len),
        26 => wire__crate__api__error__RustError_to_error_string_impl(ptr, rust_vec_len, data_len),
        28 => wire__crate__api__settings__SshKey_public_key_impl(ptr, rust_vec_len, data_len),
        32 => wire__crate__api__settings__SshKey_uuid_impl(ptr, rust_vec_len, data_len),
        41 => wire__stride_backend_git__encryption_key__encryption_key_validate_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
