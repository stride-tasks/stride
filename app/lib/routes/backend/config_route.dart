...
class _BackendConfigRouteState extends State<BackendConfigRoute> {
  ...
  void initState() {
    super.initState();
    print(widget.backend.config);
    json = jsonDecode(widget.backend.config) as Map<String, dynamic>;
    _sshKeys = sshKeys();
  }
  ...
  Widget build(BuildContext context) {
    ...
    for (final entry in config.fields.entries) {
      ...
      switch (value.type) {
        case ValueType.url:
        case ValueType.string:
          print('URL/string: ${value.content as String?}');
        ...
        case ValueType.uuid:
          print('UUID: ${value.content as UuidValue?}');
