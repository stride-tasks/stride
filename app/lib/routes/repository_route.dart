            ...
            sections: [
              ...
              SettingsSection(
                ...
                tiles: [
                  ...
                  //     hasDelete: false,
                  //     selected: repositorySpec.sshKeyUuid,
                  //     onTap: (key) {
                  //       final repositories = settings.repositories
                  //           .map(
                  //             (e) => (e.uuid != repositorySpec.uuid)
                  ...
                  //   builder: (context) =>
                  //       EncryptionKeyRoute(repository: repositorySpec),
                  // ),
                  SettingsTile(
