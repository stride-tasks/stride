...
// These functions are ignored (category: IgnoreBecauseOwnerTyShouldIgnore): `next`
            ...
            String oidToString({required Oid oid }) => RustLib.instance.api.crateApiRepositoryGitOidToString(oid: oid);
...
static TaskStorage  load({required UuidValue uuid })=>RustLib.instance.api.crateApiRepositoryGitTaskStorageLoad(uuid: uuid);


 Future<List<CommitItem>?>  log({Oid? oid , int? n });


factory TaskStorage({required UuidValue repositoryUuid , required String path , required Settings settings })=>RustLib.instance.api.crateApiRepositoryGitTaskStorageNew(repositoryUuid: repositoryUuid, path: path, settings: settings);
...
final String email;
                ...
                const CommitItem({required this.oid ,this.parent ,required this.message ,required this.author ,required this.email ,});
        ...
        @override
        int get hashCode => oid.hashCode^parent.hashCode^message.hashCode^author.hashCode^email.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is CommitItem &&
                ...
                && oid == other.oid&& parent == other.parent&& message == other.message&& author == other.author&& email == other.email;
