...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -1617300338;
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  get kStrideBackendGitEncryptionKeyEncryptionKeyGenerateConstMeta =>
      const TaskConstMeta(debugName: 'encryption_key_generate', argNames: []);
  ...
  BackendRecord dco_decode_backend_record(dynamic raw) {
    ...
    return BackendRecord(
      ...
      config: dco_decode_String(arr[3]),
    );
  }
  ...
  EncryptionKey dco_decode_encryption_key(dynamic raw) {
    ...
    return EncryptionKey(key: dco_decode_list_prim_u_8_strict(arr[0]));
  }
  ...
  EncryptionKey sse_decode_encryption_key(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    final var_key = sse_decode_list_prim_u_8_strict(deserializer);
...
class RustErrorImpl extends RustOpaque implements RustError {
  ...
  bool isKeyStoreVerification() => RustLib.instance.api
      .crateApiErrorRustErrorIsKeyStoreVerification(that: this);
