...
// These functions are ignored (category: IgnoreBecauseExplicitAttribute): `add`, `as_ref`, `from_str`, `from_str`, `host`, `hosts`, `name`, `new`, `new`, `parse_str`, `read_file`, `read_standard_file`, `short_name`, `try_from`, `write_file`, `write_standard_file`
