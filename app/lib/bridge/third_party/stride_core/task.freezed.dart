...
class _Task extends Task {
  const _Task({required this.uuid, required this.entry, required this.status, required this.title, this.modified, this.due, this.project, required final  List<String> tags, required final  List<Annotation> annotations, this.priority, this.wait, required final  List<UuidValue> depends, required final  List<Uda> udas}): _tags = tags,_annotations = annotations,_depends = depends,_udas = udas,super._();
...
/// Create a copy of Task
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? uuid = null,Object? entry = null,Object? status = null,Object? title = null,Object? modified = freezed,Object? due = freezed,Object? project = freezed,Object? tags = null,Object? annotations = null,Object? priority = freezed,Object? wait = freezed,Object? depends = null,Object? udas = null,}) {
  return _then(_Task(
uuid: null == uuid ? _self.uuid : uuid // ignore: cast_nullable_to_non_nullable
as UuidValue,entry: null == entry ? _self.entry : entry // ignore: cast_nullable_to_non_nullable
as DateTime,status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
