...
// These functions are ignored because they are not marked as `pub`: `append`, `clear`, `filter`, `get_by_id`, `get_index`, `load`, `new`, `remove`, `remove`, `save`, `storage_mut`, `unload`, `update`, `with_authentication`
